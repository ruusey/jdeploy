...
public class DeploymentHelper {
    ...
    private String readChannel(Channel channel) {
    ...
    public String readShell() {
       return this.readChannel(this.shellChannel);
    }

    public String readExec() {
        return this.readChannel(this.execChannel);
    }
    
    private void writeChannel(String command, Channel channel) {
        try {
    ...
    public void writeShell(String command) {
       this.writeChannel(command, this.shellChannel);
    }
    
    public void writeExec(String command) {
        this.writeChannel(command, this.execChannel);
     }
    ...
    public void doKillRun(String sourceFile, String redirectOut) {
        ...
        try {
            ...
            log.info("Executed kill and run for file {}  in {}ms", sourceFile, (Instant.now().toEpochMilli() - start));
        } catch (Exception e) {
    ...
    public void doSftp(String sourceFile, String targetFile) {
        try {
            ...
            log.info("Storing file as remote filename: {} under path {}", extractFileParts(targetFile)[1], extractFileParts(targetFile)[0]);
    ...
    public void deployAndRun(String sourceFile, String targetFile) {
        try {
            ...
            log.info("Deployment of file {} to remote directory {} completed in {}ms", extractFileParts(sourceFile)[1], targetFile,
