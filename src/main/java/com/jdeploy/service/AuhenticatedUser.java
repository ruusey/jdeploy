...
public class AuhenticatedUser implements UserInfo, UIKeyboardInteractive {
	private final static GridBagConstraints LAYOUT = new GridBagConstraints(0, 0, 1, 1, 1, 1,
	...
	public boolean promptYesNo(String str) {
		...
		final int foo = JOptionPane.showOptionDialog(null, str, "Warning", JOptionPane.DEFAULT_OPTION,
