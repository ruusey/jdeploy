...
public class DeploymentHelper {
    ...
    public void doKillRun(String sourceFile, String redirectOut) {
        ...
        try {
            ...
            LOGGER.info("Executed kill and run for file {}  in {}ms", sourceFile, (Instant.now().toEpochMilli() - start));
        } catch (Exception e) {
    ...
    public void doSftp(String sourceFile, String targetFile) {
        try {
            ...
            LOGGER.info("Storing file as remote filename: {} under path {}", extractFileParts(targetFile)[1], extractFileParts(targetFile)[0]);
    ...
    public void deployAndRun(String sourceFile, String targetFile) {
        try {
            ...
            LOGGER.info("Deployment of file {} to remote directory {} completed in {}ms", extractFileParts(sourceFile)[1], targetFile,
